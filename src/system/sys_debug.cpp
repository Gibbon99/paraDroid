...
//-----------------------------------------------------------------------------
{
	...
	al_draw_textf(builtInFont, al_map_rgb_f(1.0f, 1.0f, 1.0f), 1.0f, winHeight - 50, ALLEGRO_ALIGN_LEFT, "Flash [ %3.2f ] Index [ %i ] Transfer  [ %3.3f ]", playerFlashValue, playerDroidTypeDBIndex, playerTransferTimeRemaining);

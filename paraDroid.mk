...
SourceSwitch           :=-c 
OutputFile             :=bin/Release/paraDroid
Preprocessors          :=
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
LinkOptions            :=  -s 
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)hdr/script $(IncludeSwitch)hdr/physfs 
IncludePCH             := 
RcIncludePath          := 
...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS := -pg -std=c++11 -O2 -Wall -fexceptions  $(Preprocessors)
